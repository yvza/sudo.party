...
export default function BottomNav() {
  ...
  return (
    <footer
      role="contentinfo"
      className="mx-auto px-5 py-6 text-center sm:text-left text-xs text-gray-500 dark:text-gray-400 bg-white dark:bg-neutral-900 border-t border-slate-200 dark:border-neutral-700 shadow-sm"
    >
